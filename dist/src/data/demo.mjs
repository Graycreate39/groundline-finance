...
export const rows=[
 {id:'revenue',label:'Revenue',unit:'$m',kind:'section',values:[82.1,108.7,142.3,186.4,235.8,287.7,337.1,382.6],source:'Bundled demo snapshot',formula:'Prior year revenue × (1 + growth)'},
 ...
 {id:'grossprofit',label:'Gross profit',unit:'$m',values:[57.5,77.2,103.9,139.8,180.4,224.4,267.0,306.1],source:'Bundled demo snapshot',formula:'Revenue × gross margin'},
 {id:'grossmargin',label:'Gross margin',unit:'%',values:[.70,.71,.73,.75,.765,.78,.792,.80],source:'Inferred',formula:'Gross profit ÷ revenue'},
 {id:'rd',label:'Research & development',unit:'$m',values:[31.2,37.4,43.8,52.2,61.3,69.0,76.2,82.3],source:'Bundled demo snapshot',formula:'Revenue × R&D %'},
 {id:'sales',label:'Sales & marketing',unit:'$m',values:[38.6,43.5,48.4,55.9,63.7,69.0,72.5,75.0],source:'Bundled demo snapshot',formula:'Revenue × S&M %'},
...
export const evidence=[
 {id:'ev-001',title:'Arcwell FY24 annual report',date:'2025-02-14',type:'Company filing · bundled demo snapshot',claim:'FY24 revenue was $142.3m',status:'Bundled demo snapshot',confidence:98,used:true,excerpt:'Revenue for the year ended December 31, 2024 was $142.3 million.'},
