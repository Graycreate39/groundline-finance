...
for(const requirement of ['Research company','User-entered','Material gaps','Current as of'])if(!app.includes(requirement))throw new Error(`Research-first UI is missing: ${requirement}`);
